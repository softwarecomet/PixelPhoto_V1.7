    ...
    public class FontTypeFaceAdapter : RecyclerView.Adapter
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var itemView = LayoutInflater.From(parent.Context)
                    .Inflate(Resource.Layout.row_fontTypeFace, parent, false);
        ...
        public void GetFontTypeFace()
        {
            try
            {
                ...
                var fontTxt7 = Typeface.CreateFromAsset(ActivityContext.Assets, "SF-UI-Display-Regular.ttf");
                ...
                MFontTypeFacesList.Add(fontTxt7);
