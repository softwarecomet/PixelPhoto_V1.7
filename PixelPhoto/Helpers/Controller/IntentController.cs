...
namespace PixelPhoto.Helpers.Controller
{
    public class IntentController
    {
        ...
        public void OpenIntentImageGallery(string title, bool allowMultiple = true)
        {
            try
            {
                Intent intent = Android.OS.Environment.GetExternalStorageState(null).Equals(Android.OS.Environment.MediaMounted) ? new Intent(Intent.ActionPick, MediaStore.Images.Media.ExternalContentUri) : new Intent(Intent.ActionPick, MediaStore.Images.Media.InternalContentUri);
        ...
        public void OpenIntentVideoGallery(string title = "video")
        {
            try
            {
                Intent intent = Android.OS.Environment.GetExternalStorageState(null).Equals(Android.OS.Environment.MediaMounted) ? new Intent(Intent.ActionPick, MediaStore.Video.Media.ExternalContentUri) : new Intent(Intent.ActionPick, MediaStore.Video.Media.InternalContentUri);
        ...
        public void OpenIntentLocation()
        {
            ...
            //    Context.StartActivityForResult(builder.Build(Context), 502);
            //}
            ...
            //{
            //    Console.WriteLine(exception);
            //    Toast.MakeText(Context, "Google Play Services exception", ToastLength.Short).Show();
            //}
        }
        ...
        public void OpenIntentAudio()
        {
            try
            {
                Intent intent = Android.OS.Environment.GetExternalStorageState(null).Equals(Android.OS.Environment.MediaMounted) ? new Intent(Intent.ActionPick, MediaStore.Audio.Media.ExternalContentUri) : new Intent(Intent.ActionPick, MediaStore.Audio.Media.InternalContentUri);
