...
{
    public class PixelDefaultFooter : BaseFooter
    {
        ...
        public PixelDefaultFooter(Activity context)
        {
            MainContext = context;
        ...
        {
            View view = inflater.Inflate(Resource.Layout.PixelPullRefreshFooter, viewGroup, true);
