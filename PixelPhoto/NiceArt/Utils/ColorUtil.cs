...
namespace PixelPhoto.NiceArt.Utils
{
    public class ColorUtil
    {
        ...
        public static int MixTwoColors(int color1, int color2, float amount)
        {
            ...
            int a = (int)((float)(color1 >> alphaChannel & 0xff) * amount + (float)(color2 >> alphaChannel & 0xff) * inverseAmount) & 0xff;
            int r = (int)((float)(color1 >> redChannel & 0xff) * amount + (float)(color2 >> redChannel & 0xff) * inverseAmount) & 0xff;
            int g = (int)((float)(color1 >> greenChannel & 0xff) * amount + (float)(color2 >> greenChannel & 0xff) * inverseAmount) & 0xff;
